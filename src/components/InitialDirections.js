...
export default function InitialDirections() {
  return(
    <div>
      <br/>
      <div id='helpText'>
      ...
      <div className='yourLikedArtists'></div>
      <button type="button" onclick={this.props.handleShowSwipeComponents.bind(this)}>Done!</button>
    </div>
    )}
